...
export const fetchFlightsFromApi = async (
  ...
  const url = `${baseUrl}?fly_from=${fly_from}&fly_to=${fly_to}&date_from=${dateFromFormated}&date_to=${dateToFormated}&direct_flights=${direct_flights}&limit=100&partner=picky`;
  console.log("url", url);
